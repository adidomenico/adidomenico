...
Software engineer with a Data Science background, working on real-time media
processing, distributed systems, and blockchain. Currently building server-side
SDKs and backend services for Vonage's Video API.
